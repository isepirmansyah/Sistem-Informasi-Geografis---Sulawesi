    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6 bg-gradient-to-r from-amber-500 to-amber-600">
                <h1 class="text-2xl font-bold text-white">Peta Tematik IPM Sulawesi</h1>
                <p class="text-amber-100 mt-2">Visualisasi Indeks Pembangunan Manusia di provinsi-provinsi Sulawesi</p>
            </div>
    ...
    <script>
        ...
        function style(feature) {
            ...
            if (province && province.thematic_data && province.thematic_data.length > 0 && province.thematic_data[0] &&
                province.thematic_data[0].human_development_index) {
                hdi = parseFloat(province.thematic_data[0].human_development_index);
            }
        ...
        legend.onAdd = function(map) {
            ...
            const grades = [68, 70, 72, 74, 76];
            const colors = ['#ffd54f', '#ffca28', '#ffc107', '#ffb300', '#ffa000'];
            div.innerHTML = '<h4>Indeks Pembangunan Manusia</h4>';
            for (let i = 0; i < grades.length; i++) {
                div.innerHTML +=
            ...
            div.innerHTML += `<i style="background:#ff6f00"></i>` + grades[grades.length - 1].toLocaleString('id-ID') +
                '+';
            return div;
        };
